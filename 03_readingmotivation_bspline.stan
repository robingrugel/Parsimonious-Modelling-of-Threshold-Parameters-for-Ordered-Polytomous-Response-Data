...
parameters{
  ...
  real<lower=0,upper=pi()/2> sigma_theta_control_raw; // raw standard deviation of ability parameter in control group
  real<lower=0,upper=pi()/2> sigma_theta_treat_raw; // raw standard deviation of ability parameter in treatment group
  
  cholesky_factor_corr[2] corr_control; // cholesky factors for correlation matrix of the control group
  cholesky_factor_corr[2] corr_treat; // cholesky factors for correlation matrix of the treatment group
}
